...
public class Physiotherapist_InjuryEx extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    public Physiotherapist_InjuryEx() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        page.setIcon(new javax.swing.ImageIcon("C:\\Users\\giann\\Downloads\\Mockups-FM\\Mockups\\FM-Phys-InjRehab.png")); // NOI18N
        page.setText(" ");
        getContentPane().add(page, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 840, 570));

        jComboBox_Plan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Inj. Rehab  Exercise 1", "Inj. Rehab  Exercise 2", "Inj. Rehab  Exercise 3", "Inj. Rehab  Exercise 4" }));
        ...
        getContentPane().add(create, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 510, 120, 20));

        import_video.setText("jButton1");
        getContentPane().add(import_video, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 510, 120, 20));

        edit.setText("jButton1");
        getContentPane().add(edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 510, 120, 20));
