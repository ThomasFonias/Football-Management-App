...
public class Player_MyCalendar_Nutrition extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    public Player_MyCalendar_Nutrition() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        page.setIcon(new javax.swing.ImageIcon("C:\\Users\\giann\\Downloads\\Mockups-FM\\Mockups\\FM-Pl-Nutr.png")); // NOI18N
        page.setText(" ");
        ...
        getContentPane().add(jComboBox_FromDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 130, 140, 30));

        jComboBox_EndDate.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "5/3/23", "6/3/23", "7/3/23", "8/3/23" }));
        getContentPane().add(jComboBox_EndDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 130, 140, 30));
